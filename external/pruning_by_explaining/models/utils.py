...
class ModelLoader:
    ...
    @staticmethod
    def load_model(architecture, num_classes=1000, checkpoint_path=None, **kwargs):
        """
        model loader
        ...
        model_dict = {
            ...
            "vit_b_16": {"loader": load_vit_b_16, "params": (checkpoint_path,num_classes)},
        }
    ...
    def get_basic_model(architecture, checkpoint_path, device, num_classes=1000):
        ...
        model, _ = ModelLoader.load_model(architecture, num_classes)
